...
export function PlantCard({ plant }: { plant: Plant }) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition hover:shadow-md hover:border-leaf/40 focus-within:ring-2 focus-within:ring-leaf focus-within:ring-offset-2">
      <Link
        to="/app/plantas/$id"
        params={{ id: plant.id }}
